...
export class Map extends React.Component<any, any> {
    ...
    onClick(event : React.MouseEvent<HTMLElement>) {
        ...
        var column: number = Math.round(x/(3/4*width)); // Primero, encontramos la columna aproximada, dividiendo la posición por 3/4 la anchura (debido a los siguientes cálculos)
